...
import conversionIcons from "../../assets/conversion-icons.png";
import conversionText from "../../assets/conversion-text.png";

const LandingPostRaffle = () => {
    return (
        <div className="home">
            <div className="container home-content postraffle">
                ...
                <div className="conversion-box" >
                    <img className="logo-conversionIcons" src={ conversionIcons }/>
                    <img className="logo-conversionText" src={ conversionText }/>
                </div>
...
export default LandingPostRaffle
